                        ...
                        <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10 lg:w-[52%] lg:px-12 lg:py-10">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Masuk ke dashboard untuk mengelola outlet TehMbois kamu.
                                </p>
                            </div>
                            ...
                            <div className="mt-5 rounded-xl border border-primary/15 bg-primary/5 p-3.5">
                                <p className="text-xs font-semibold text-foreground">ℹ️ Info Login</p>
                                <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                                    Gunakan akun owner atau kasir yang terdaftar. Hubungi admin pusat jika lupa akses.
                                </p>
                            </div>
